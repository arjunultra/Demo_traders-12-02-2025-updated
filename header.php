<header>
    ...
    <!-- Navbar with Logo -->
    <nav id="my-nav" class="navbar navbar-expand-lg navbar-dark sticky-top text-dark bg-light">
        <div class="container-fluid">
            <a class="navbar-brand text-red" href="index.php">
                ...
                <em class="text-main">Demo</em> <em class="text-red">Traders</em>
            </a>
    ...
    <div class="container-fluid mb-3 mt-4">
        <div class="row bg-main text-center">
            <div class="col-md-4">
                <div class="header-info-box shadow p-3 bg-warning rounded">
